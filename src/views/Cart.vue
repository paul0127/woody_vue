  ...
  <div class="contain">
    ...
    <div class="container">
      ...
      <div class="cart_bottom">
        <router-link class="btn" :to="{ path: '/' }"><i class="fa fa-angle-double-left" aria-hidden="true"></i>
          繼續購物</router-link
        >
        <router-link class="btn" :to="{ path: '/pay' }">下一步 <i class="fa fa-angle-double-right" aria-hidden="true"></i
        ></router-link>
      </div>
    </div>
  </div>
