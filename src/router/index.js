...
const routes = [
  ...
  },
  {
    ...
    name: 'Artisan',
    component: () =>
      import(/* webpackChunkName: "Artisan" */ '../views/Artisan.vue'),
    meta: { title: '工藝師介紹' },
  },
  {
    path: '/service',
  ...
  },
  {
    ...
    component: () =>
      import(
        /* webpackChunkName: "ProductSection" */ '../views/ProductSection.vue'
      ),
    meta: { title: '商品列表' },
  },
  {
    ...
    name: 'ProductInfo',
    component: () =>
      import(/* webpackChunkName: "ProductInfo" */ '../views/ProductInfo.vue'),
    meta: { title: '商品內頁' },
  },
  {
    path: '/cart',
    name: 'Cart',
    component: () =>
      import(/* webpackChunkName: "Login" */ '../views/Cart.vue'),
    meta: { title: '購物車' },
  ...
  },
  {
    ...
    name: 'Finish',
    component: () =>
      import(/* webpackChunkName: "Login" */ '../views/Finish.vue'),
    meta: { title: '完成訂購' },
  },
  {
    path: '/*',
